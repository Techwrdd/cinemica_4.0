...
✯ 𝙱𝚄𝙸𝙻𝙳 𝚅𝙴𝚁𝚂𝙸𝙾𝙽: 𝙿𝚁𝙾𝙵𝙴𝚂𝚂𝙾𝚁-𝙱𝙾𝚃 𝚟3.0.0"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 𝙲𝙻𝙸𝙲𝙺 𝙷𝙴𝚁 👉 :<a href=https://github.com/SIRFNHIMILPAYEGA/FGH>PRIVATE_REPO</a>

<b>DEVS:</b>
- 𝙳𝚎𝚟 1<a href=https://t.me/sahid_malik>Sahid malik</a>"""
...
<code>/batch https://https://t.me/apzentertainmentbackup</code>

𝙲𝚁𝙴𝙳𝙸𝚃𝚂 ›› <a href=https://https://t.me/apzentertainmentbackup><b>TEAM_APZ</b></a>"""
...
𝙲𝚁𝙴𝙳𝙸𝚃𝚂 :- <a href=https://t.me/ankitpatel40>ANKIT_PATEL_TG</a>**"""
...
• ᴜꜱᴇʀɴᴀᴍᴇ : @akshatsg
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/akshatsg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
𝖸𝗈𝗎 𝖼𝖺𝗇 𝗎𝗌𝖾 𝗏𝖺𝗅𝗎𝖾𝗌: 𝗆/𝗁/𝖽. 
 ...
 • 𝖽 = 𝖽𝖺𝗒𝗌"""
    ...
    FORCESUB_TXT = """𝑱𝒐𝒊𝒏 𝑶𝒖𝒓 𝑴𝒐𝒗𝒊𝒆 𝑼𝒑𝒅𝒂𝒕𝒆𝒔 𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑻𝒐 𝑼𝒔𝒆 𝑻𝒉𝒊𝒔 𝑩𝒐𝒕!"""
...
MALIK2 = """<b>Hello {} 👋
Please verify captcha. This is done in order to protect spamming in the bot.</b>"""

SECOND_VERIFICATION_TEXT = """<b>Hello {} 👋
Please verify captcha. This is done in order to protect spamming in the bot.</b>"""
...
You have completed the first verification

JOIN THIS CHANNEL FOR COMPLETING THE FINAL VERIFICATION 🔽"""



SECOND_VERIFY_COMPLETE_TEXT = """Hello {} 👋 
You have completed the first verification
